...
This HTML site is hosted via GitHub Pages and embedded as an iFrame to DCA's Annexation Reporting & Resources ArcGIS Hub site.
...
We will walk through installing Python in Section 1. If you already have Python, skip to Section 2.
  ...
  4. If you already have Python, you'll instead see a version number returned in the Command Prompt output.

**SECTION 2 - EDITING, PREVIEWING, & TESTING THE INDEX.HTML FILE**
You will need to set up a Local HTTP Server on your computer to test the .html file.
Simply opening the .html file with your internet browser won't work due to browser-based restrictions on loading .csv files.
If this is new for you, don't worry - it's easy! You only need to use one line of Python code. 
...
**What to do if admin is not available to push updates**
  ...
  14. Replace the link thats presently embedded with the URL link of your updated Github Page.
